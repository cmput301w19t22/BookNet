 ...
 *
 *  1. Use a new NotificationCompatBuilder to create the InAppNotification. This approach requires you
 ...
 *
 *  2. Use an existing NotificationCompatBuilder to create a InAppNotification. This approach requires
 ...
 *
 *  IMPORTANT NOTE 1: You shouldn't save/modify the resulting InAppNotification object using
 ...
 *
 *  IMPORTANT NOTE 2: If the global InAppNotification Builder is lost because the process is killed, you
 *  should have a way to recreate the InAppNotification Builder from a persistent state. (We do this as
